    ...
    def find_device(self):
        ...
        while try_times > 0:
            ...
            if not conf.LIVECD:
                ...
                ret = gui.dialog_choices(msg="Selectionnez le p̩riph̩rique USB sur lequel vous voulez installer UFO",
                                         title="UFO", column="P̩riph̩rique", choices= [ "Aucune cl̩e" ] + names)
                if not ret:
                    return conf.STATUS_IGNORE
