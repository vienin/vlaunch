...
os.system("VBoxManage modifyvm " + options.vm + " -boot1 disk -boot2 none -boot3 none -vram 32 -memory 1024 -usb on -usbehci on -nictype1 82540EM -biosbootmenu disabled -audio pulse")
